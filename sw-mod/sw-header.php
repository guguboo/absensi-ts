...
<head>
  ...
  <style>
    ...
    a:hover {
      color: #ff639f !important;
    }
    /* Tombol dan elemen interaktif lainnya */
    .btn-primary {
      background-color: #000000;
      border-color: #000000;
    }
    /* Tambahkan gaya lain sesuai kebutuhan agar konsisten dengan tema gelap */
  </style>
        ...
        <div class="right">
            <div class="headerButton" data-toggle="dropdown" id="dropdownMenuLink" aria-haspopup="true">';
              if($row_user['photo'] ==''){
                ...
                echo'<img src="timthumb?src='.$base_url.'sw-content/karyawan/'.$row_user['photo'].'&h=40&w=45" alt="image" class="imaged w32" />';
              }
              echo'
