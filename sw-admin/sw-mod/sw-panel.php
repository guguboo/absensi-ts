...
echo'<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      if($mod =='karyawan' OR $mod=='jabatan' OR $mod=='shift' OR $mod=='lokasi' OR $mod=='libur' OR $mod=='gaji'){ 
    ...
    if($level_user =='1'){
      echo'
          ...
          <ul class="treeview-menu">';
            ...
            // Tambah menu Gaji Karyawan di sini
            if($mod =='gaji'){echo'<li class="active">'; }else{echo'<li>';}
             echo'<a href="./gaji"><i class="fa fa-money"></i> Gaji Karyawan</a></li>';
          echo'</ul>
        </li>';
     }
