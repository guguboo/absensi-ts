  ...
  <div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <div class="box box-solid">
        ...
        <div class="box-body">
            <form class="form-horizontal validate add-karyawan" enctype="multipart/form-data" method="post" action="proses.php?act=add_karyawan">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="email" class="form-control" name="employees_email" required>
                  </div>
                </div>
      ...
      <div class="nav-tabs-custom">
        <div class="tab-content">
          <div class="tab-pane active" id="tab_1">
            ...
            <form class="form-horizontal validate update-karyawan" enctype="multipart/form-data" method="post" action="proses.php?act=update_karyawan">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">Email</label>
                  <div class="col-sm-6">
                    <input type="email" class="form-control" name="employees_email" value="'.$row['employees_email'].'" readonly required>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    ...
                    if($row['photo'] == NULL){
                      ...
                      echo'<img src="../sw-content/karyawan/'.$row['photo'].'" id="output" class="img-responsive" width="100">';
                    }
                    echo'
                         <input type="file" class="upload-hidden" name="photo" onchange="loadFile(event)" accept="image/jpeg, image/jpg, image/gif">
                    </div>
          ...
          <div class="tab-pane" id="tab_2">
            <form class="form-horizontal validate update-password" method="post" action="proses.php?act=update_password">
              <div class="box-body">
                <div class="form-group">
                  <label class="col-sm-2 control-label">Email</label>
                  <div class="col-sm-6">
